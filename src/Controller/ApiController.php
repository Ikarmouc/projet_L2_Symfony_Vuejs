...
class ApiController extends AbstractController
{
    ...
    public function addProduct(Request $request ,CategorieRepository $categorieRepository,SerializerInterface $serializer)
    {
        ...
        foreach ($content->categorie as $category)
        {
            $produit->addCategorie($categorieRepository->find($category));
    ...
    public function getAllProducts(ProduitRepository $produitRepository,NormalizerInterface $serializer)
    {
